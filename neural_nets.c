...
{
    int expected_val = SLOW_WALK; //for slow walk training
    ...
    while ((read = getline(&line, &len, fp)) != -1)
    {
        ...
        rv = sscanf(line, "%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f"
                    ...
                    &input[28], &input[29], &input[30], &input[31], &input[32], &input[33], &input[34],
                    &input[35], &input[36], &input[37], &input[38], &input[39], &input[40], &input[41],

                    &input[42], &input[43], &input[44], &input[45], &input[46], &input[47], &input[48],
                    &input[49], &input[50], &input[51], &input[52]
        ); //&a_inputs[1] NO_SAMPLES times
