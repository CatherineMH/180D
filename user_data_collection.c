...
void collect_data( const char Name[], char Activity[], int act_time){
	//Variables
	...
	fp = fopen(ifile, "w"); // NB! file_name does not exists, so, ifile instead of file_name
	if (fp == NULL)
	{
		...
		case 1:
			while ((answer != 'y') && run_flag) {
				if (answer == 'n') {
					...
					sleep(1);
					collect_data(USERNAME, "ws", T1); //walking slow
		...
		case 2:
			while ((answer != 'y')&&run_flag){
				if (answer == 'n') {
					...
					sleep(1);
				    collect_data(USERNAME, "wm", T2); //walking medium
                     printf("Are you satisfied with this activity (y/n)? ");
                    scanf("%c", &answer);
                    //ch = getchar();
				}
		...
		case 3:
			while ((answer != 'y')&&run_flag){
				if (answer == 'n') {
                    ...
                    sleep(1);
                    collect_data(USERNAME, "wf", T3); //walking fast
                    printf("Are you satisfied with this activity?(y/n) ");
                    scanf("%c", &answer);
                    //ch = getchar();
                }
		...
		case 4:
			while ((answer != 'y')&&run_flag){
				if (answer == 'n') {
                    ...
                    sleep(1);
                    collect_data(USERNAME, "js", T1); //jump short
		...
		case 5:
			while ((answer != 'y')&&run_flag){
				if (answer == 'n') {
                    ...
                    sleep(1);
                    collect_data(USERNAME, "jm", T1);//jump medium
                    printf("Are you satisfied with this activity? ");
                    scanf("%c", &answer);
                    //ch = getchar();
                }
		...
		case 6:
			while ((answer != 'y')&&run_flag){
				if (answer == 'n') {
                    ...
                    sleep(1);
                    collect_data(USERNAME, "jh", T1); //jump high
                    printf("Are you satisfied with this activity? ");
                    scanf("%c", &answer);
                    //ch = getchar();
                }
		...
		case 7:
			while ((answer != 'y')&&run_flag){
				if (answer == 'n') {
                    ...
                    sleep(1);
                    collect_data(USERNAME, "sus", T1);//stair up slow
                    printf("Are you satisfied with this activity? ");
                    scanf("%c", &answer);
                    //ch = getchar();
                }
		...
		case 8:
			while ((answer != 'y')&&run_flag){
				if (answer == 'n') {
                    ...
                    sleep(1);
                    collect_data(USERNAME, "sum", T2);//stair up medium
                    printf("Are you satisfied with this activity? ");
                    scanf("%c", &answer);
                    //ch = getchar();
                }
		...
		case 9:
			while ((answer != 'y')&&run_flag){
				if (answer == 'n') {
                    ...
                    sleep(1);
                    collect_data(USERNAME, "suf", T3);//stair up fast
                    printf("Are you satisfied with this activity? ");
                    scanf("%c", &answer);
                    //ch = getchar();
                }
		...
		case 10:
			while ((answer != 'y')&&run_flag){
				if (answer == 'n') {
                    ...
                    sleep(1);
                    collect_data(USERNAME, "sds", T1);//stair down slow
                    printf("Are you satisfied with this activity? ");
                    scanf("%c", &answer);
                    //ch = getchar();
                }
		...
		case 11:
			while ((answer != 'y')&&run_flag){
				if (answer == 'n') {
                    ...
                    sleep(1);
                    collect_data(USERNAME, "sdm", T2);//stair down medium
                    printf("Are you satisfied with this activity? ");
                    scanf("%c", &answer);
                    //ch = getchar();
                }
		...
		case 12:
			while ((answer != 'y')&&run_flag){
				if (answer == 'n') {
					...
					sleep(1);
					collect_data(USERNAME, "sdf", T3);//stair down fast
					printf("Are you satisfied with this activity? ");
					scanf("%c", &answer);
                    //ch = getchar();
				}
		...
		case 13:
			while ((answer != 'y')&&run_flag){
				if (answer == 'n') {
					...
					sleep(1);
					collect_data_turn(USERNAME, "tr", T4);//turn right
		...
		case 14:
			while ((answer != 'y')&&run_flag){
				if (answer == 'n') {
					...
					printf("Please note that you should turn each 4 seconds\n");
					sleep(1);
					collect_data_turn(USERNAME, "tl", T4);//turn left
					printf("Are you satisfied with this activity? \n");
					scanf("%c", &answer);
                    //ch = getchar();
				}
