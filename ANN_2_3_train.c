...
/*
 * ******************DOWNSTAIRS SPEED DETECTION ANN TRAINING FILE****************************
 * */
int ANN_2_3_train(char NAME[])
{
    ...
    strcat(result, NAME);
    strcat(result, "_RESULT_ANN_2_3.net");
    fann_save(ann, result);  //ANN_0.net-walk speed, ANN_1-upstairs speed, ANN_2-downstairs speed, ANN_3-jump height
